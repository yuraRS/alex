(() => {
    ...
    const mainInputOne = mainForm.mainInputOne;
    const mainArea = mainForm.mainArea;
    mainForm.addEventListener("submit", (function(event) {
        if (emailTest(mainInput)) {
            mainInput.classList.add("_error");
            event.preventDefault();
        }
        if (emailTest(mainInputOne)) {
            mainInputOne.classList.add("_error");
            event.preventDefault();
        }
        if (emailTest(mainArea)) {
            mainArea.classList.add("_error");
            event.preventDefault();
        }
    }));
    mainForm.addEventListener("focusout", (function(event) {
        mainInput.classList.remove("_error");
        mainInputOne.classList.remove("_error");
        mainArea.classList.remove("_error");
    }));
    ...
    mainInput.addEventListener("blur", (function(event) {
        mainInput.placeholder = '"Name"';
    }));
    mainInputOne.addEventListener("focus", (function(event) {
        mainInputOne.placeholder = "";
    }));
    mainInputOne.addEventListener("blur", (event => {
        mainInputOne.placeholder = "Email";
    }));
    mainArea.addEventListener("focus", (function(event) {
        mainArea.placeholder = "";
    }));
    mainArea.addEventListener("blur", (event => {
        mainArea.placeholder = "Email";
    }));
    window["FLS"] = true;
    isWebp();
    tabs();
